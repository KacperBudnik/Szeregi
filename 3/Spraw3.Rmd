...
#tmp<-auto.arima(diff(BoxCox(energia, lambda=2.5),lag=12))
#tmp$aic
```
...
Co ciekawe, poza tym jednym przypadkiem, funkcja \verb|auto.arima| zwraca podobne oszacowania rzędu, niezależnie od zastosowanych przekształceń (w większości rzędy różnią się od siebie łącznie o 1). Jedynie dane po transformacie logarytmicznej dają modele znacznie mniejszych rzędów w metodzie parametrycznej.

...
chartSeries(kghm, TA=c(addBBands(), addMACD(),addSMI(), addADX()), type="auto")#, subset = '2018-01::')
...
{
  autoplot(MACD(Cl(kghm)),maType="EMA",nSlow=slow.win[i])
...
{
  autoplot(MACD(Cl(kghm)),maType="EMA",nFast=fast.win[i])

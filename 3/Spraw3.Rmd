...
```
Możemy zauważyć, że według naszej prognozy, w najbliższych latach temperatura delikatnie spadnie, jednak w ciągu 10 lat będzie zachowywać trend dodatni i ostatecznie temperatura będzie wyższa niż w poprzednich okresach. Możemy zobaczyć jak będzie wyglądała predykcja na dłuższy okres.
